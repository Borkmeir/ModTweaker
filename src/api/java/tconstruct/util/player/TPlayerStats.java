...
public class TPlayerStats implements IExtendedEntityProperties //TODO: IExtendedEntityProperties is not appropriate!
{
    ...
    public void saveNBTData (NBTTagCompound compound)
    {
        ...
        if(armor != null) armor.saveToNBT(tTag);
        if(knapsack != null) knapsack.saveToNBT(tTag);
    ...
    public void loadNBTData (NBTTagCompound compound)
    {
        ...
        if(armor != null) this.armor.readFromNBT(properties);
        if(knapsack != null) this.knapsack.readFromNBT(properties);

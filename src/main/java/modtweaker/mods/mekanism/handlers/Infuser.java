...
public class Infuser {
    ...
    public static void addRecipe(String type, int infuse, IItemStack input, IItemStack output) {
        ...
        MineTweakerAPI.tweaker.apply(new AddMekanismRecipe("METALLURGIC_INFUSER", infuseIn, infuseOut));
    }

    @ZenMethod
    public static void removeRecipe(IItemStack output) {
        MineTweakerAPI.tweaker.apply(new RemoveMekanismRecipe("METALLURGIC_INFUSER", toStack(output)));
    }
}
